...
$CLIENT_FILE_AUTHOR = "sasaanfafaan"
...
$CLIENT_FILE_DISPLAY_NAME = "Techmyth - $MODPACK_VERSION"
...
$SERVER_FILE_DISPLAY_NAME = "Techmyth Server - $MODPACK_VERSION"
